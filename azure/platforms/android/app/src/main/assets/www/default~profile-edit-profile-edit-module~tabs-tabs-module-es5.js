...
var ProfileEditPage = /** @class */ (function () {
    function ProfileEditPage(postPvd, modalController, router, toastController) {
    ...
    ProfileEditPage.prototype.closeModal = function () {
    ...
    ProfileEditPage.prototype.loadData = function (uType, uCode, Email) {
        var _this = this;
        this.Data = [];
    ...
    ProfileEditPage.prototype.saveData = function () {
        ...
        return new Promise(function (resolve) {
            ...
            _this.postPvd.postData(body, 'https://www.asi-ph.com/sandboxes/testAndroid/CondoProcess/').subscribe(function (data) {
                if (data['status'] == "Success") {
                    _this.openToast("Profile updated successfully!");
    ...
    ProfileEditPage.prototype.openToast = function (msg) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
...
//# sourceMappingURL=default~profile-edit-profile-edit-module~tabs-tabs-module-es5.js.map