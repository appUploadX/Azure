...
var VisitorAddRequestPage = /** @class */ (function () {
    function VisitorAddRequestPage(modalController, postPvd, router, actRoute) {
    ...
    VisitorAddRequestPage.prototype.submit = function () {
        ...
        return new Promise(function (resolve) {
            var body = {
                ...
                avName: _this.visitC,
                vuVehicleDetailsType: _this.vuVehicleDetailsType,
                vuVehicleDetailsModel: _this.vuVehicleDetailsModel,
                vuVehicleDetailsColor: _this.vuVehicleDetailsColor,
                vuVehicleDetailsPlateNo: _this.vuVehicleDetailsPlateNo,
            };
            _this.postPvd.postData(body, 'https://www.asi-ph.com/sandboxes/testAndroid/CondoProcess/').subscribe(function (data) {
                // this.router.navigate(['/user-details']);
                // if(data['status'] == "Success")
                // {
                _this.router.navigateByUrl('/tabs/tab1/visitors-details', { state: { newCode: _this.newCode, uCode: _this.uCode } });
                // }
                console.log('ok');
            });
        });
