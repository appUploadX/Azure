        ...
        return new Promise(function (resolve) {
            ...
            _this.postPvd.postData(body, 'https://www.asi-ph.com/sandboxes/testAndroid/CondoProcess/').subscribe(function (data) {
                if (data['correct'] == "yes") {
                    ...
                    _this.router.navigateByUrl('/change-password', { state: { 'from': 'TAB1' } });
                }
                resolve(true);
                console.log(data);
            });
...
var Tab2Page = /** @class */ (function () {
    function Tab2Page(postPvd, modalController, camera, imgPov, transfer, loadingCtrl) {
        this.postPvd = postPvd;
    ...
    Tab2Page.prototype.openGallery = function () {
        var _this = this;
        // alert("haha");
        this.base64img = "";
        this.camera.getPicture({
            ...
            _this.imgPov.setImage(_this.base64img);
            _this.Upload();
        }), function (error) {
            console.log(error);
        });
    };
    Tab2Page.prototype.Upload = function () {
        var _this = this;
        ...
        fileTransfer.upload(this.base64Image, 'https://www.azure-connect.com/androidUploadPic.php', options).then(function (data) {
            // alert(JSON.stringify(data));
            alert("Profile picture updated successfully!");
            _this.base64ImageX = _this.imgPov.getImage();
            // loader.dismiss();
        }, function (error) {
            alert("error");
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return Promise.all(/*! import() | visitors-details-visitors-details-module */[__webpack_require__.e("default~amenity-book-now-amenity-book-now-module~change-password-change-password-module~forgot-passw~adbc2eec"), __webpack_require__.e("visitors-details-visitors-details-module")]).then(__webpack_require__.bind(null, /*! ../visitors-details/visitors-details.module */ "./src/app/visitors-details/visitors-details.module.ts")).then(function (m) { return m.VisitorsDetailsPageModule; });
                        }
                    }
                ]
            },
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return Promise.all(/*! import() | visitor-add-request-visitor-add-request-module */[__webpack_require__.e("default~amenity-book-now-amenity-book-now-module~change-password-change-password-module~forgot-passw~adbc2eec"), __webpack_require__.e("common"), __webpack_require__.e("visitor-add-request-visitor-add-request-module")]).then(__webpack_require__.bind(null, /*! ../visitor-add-request/visitor-add-request.module */ "./src/app/visitor-add-request/visitor-add-request.module.ts")).then(function (m) { return m.VisitorAddRequestPageModule; });
                        }
                    }
                ]
            },
                ...
                children: [
                    {
                        path: '',
                        loadChildren: function () {
                            return Promise.all(/*! import() | change-password-change-password-module */[__webpack_require__.e("default~amenity-book-now-amenity-book-now-module~change-password-change-password-module~forgot-passw~adbc2eec"), __webpack_require__.e("change-password-change-password-module")]).then(__webpack_require__.bind(null, /*! ../change-password/change-password.module */ "./src/app/change-password/change-password.module.ts")).then(function (m) { return m.ChangePasswordPageModule; });
                        }
                    }
                ]
            },
