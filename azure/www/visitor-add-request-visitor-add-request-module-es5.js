...
var VisitorAddRequestPage = /** @class */ (function () {
    ...
    VisitorAddRequestPage.prototype.onChangeX = function (selectedValue) {
        ...
        return new Promise(function (resolve) {
            ...
            _this.postPvd.postData(body, 'https://www.asi-ph.com/sandboxes/testAndroid/CondoProcess/').subscribe(function (data) {
                ...
                for (var index = 0; index < data['parkDetails'].length; index++) {
                    _this.parkDetails.push(data['parkDetails']);
                }
                resolve(true);
    ...
    VisitorAddRequestPage.prototype.AdditionalName = function (i, elemx, elemSelectx) {
    ...
    VisitorAddRequestPage.prototype.theClick = function (x) {
        console.log(x);
    };
